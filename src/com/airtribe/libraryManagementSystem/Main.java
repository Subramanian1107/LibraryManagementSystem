...
public class Main {
    public static void main(String[] args) {
        ...
        Book lendingBook = BookFactory.createBook(
                        BookType.LENDING,
                        "Clean Code",
                        "Robert Martin",
                        "ISBN1",
        ...
        Book encyclopedia = BookFactory.createBook(
                        BookType.REFERENCE,
                        "Encyclopedia",
                        "Britannica",
                        "ISBN2",
        ...
        Patron patron = new Patron("P1", "Subramanian");

        system.patrons().registerPatron(patron.getId(),patron.getName());

        system.lending().checkout("123", patron);


        List<Book> suggestions =
                system.recommend().recommend(patron);
